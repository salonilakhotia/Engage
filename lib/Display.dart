...
import 'package:engage/widget/AvatarUrl.dart';
import 'package:engage/widget/Detail.dart';
import 'package:engage/widget/Blog.dart';
import 'package:engage/widget/GitLink.dart';
import 'package:engage/widget/Followers.dart';
...
class Display extends StatefulWidget {
  ...
  Display({ required this.username});
...
class _DisplayState extends State<Display> {
  ...
  var list = new List<Followers>.empty();
  bool loading = false;
  String name = "";
  String avatar_url = "";
  String gitLink = "";
  ...
  getUser(String username) async {
    ...
    var res = await http.get(Uri.parse(gitProfile));
              ...
              child: Column(
                ...
                children: <Widget>[ 
                 ...
                 Container(
                  ...
                  SizedBox(height: 8),
                  Detail(name : widget.username , public_repos : public_repos, total_followings: followings,  total_followers: followers),
                ]),
            )
        ),
      ),
